...
HD_PWD='/mnt/home/gegi/usager/lers0601/Téléchargements/pb_APP_log_comb_E2022/pb_APP_log_comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Add4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Add4bit.tcl -notrace
